...
/// Chromium browser profile detection. Ported from v1 unchanged: profiles are
/// resolved from lsof output (open profile lock files) cross-checked against
/// the browser's Local State JSON.
