...
/// JSON-lines file logger with size rotation and age-based pruning.
/// Ported from v1 (proven in production); concurrency-safe via an internal queue.
public final class ShitsuraeLogger: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "shitsurae.logger")
